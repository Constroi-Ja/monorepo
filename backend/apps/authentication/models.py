...
class Company(models.Model):
    ...
    base_price_leve = models.DecimalField(max_digits=8, decimal_places=2, default=0)
    base_price_medio = models.DecimalField(max_digits=8, decimal_places=2, default=0)
    base_price_meio_pesado = models.DecimalField(max_digits=8, decimal_places=2, default=0)
    base_price_pesado = models.DecimalField(max_digits=8, decimal_places=2, default=0)
    rating_average = models.DecimalField(max_digits=3, decimal_places=2, default=0)
    rating_count = models.PositiveIntegerField(default=0)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
